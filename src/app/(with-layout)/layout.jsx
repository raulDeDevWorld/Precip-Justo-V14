      ...
      <div className={`fixed top-[60px] w-[220px] border-l-8 border-r-4 border-white h-screen bg-gray-50 h-screen transition-all	z-50 ${nav ? 'left-0  ' : 'left-[-220px] lg:left-[-200px] '}`} >
        ...
        <div class="py-4 overflow-y-auto ">
          <ul class="space-y-2 text-[16px]  text-gray-600 font-medium">
            <li>
              <Link href="/Distribuidor/Perfil" class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <li>
              <Link href="#" class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <li>
              <Link href="/Distribuidor/Productos" class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
