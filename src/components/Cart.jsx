...
export default function Button({ theme, styled, click, children }) {
    ...
    return (<div className={` transition-all ease-in-out duration-300  z-40`}>
        <button type="button" onClick={() => setShowCart(!showCart)} class="h-[35px] w-[35px] my-1 text-blue-700 bg-[#0064FA] border border-gray-700 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
